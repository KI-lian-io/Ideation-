...
3. **Stage 3 activation**: Supabase EU project + migration + Google OAuth + env vars; Stripe subscription Price (3,99–5,99 € decision) + webhook secret + service-role key; §312k/AGB/Datenschutz legal review on a preview deployment with env set; full accounts E2E.
