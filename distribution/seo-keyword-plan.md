...
**Structure outline:**
1. Why international CVs get rejected on format, not experience (the norm gap; correct the "8-second scan" myth with the DACH-evidenced ~43-second figure per `positioning-fact-check-2026-07.md`)
...
|-----------|-----------------|
| Keyword clusters (Cluster A) | `community-plan.md` – the myth-busting norm-gap explainer post (D-05 Post 1, "43 seconds, not 8") mirrors Cornerstone 1's positioning; reuse framing |
